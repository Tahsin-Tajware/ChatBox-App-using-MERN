    ...
    return (
        <div className='h-full w-auto px-1'>
            <div className='flex justify-between gap-2 relative'>
                <form onSubmit={handleSearchSubmit} className='w-auto flex items-center justify-between bg-white dark:bg-gray-800 rounded-full'>
                    <input
                        value={searchInput}
                        onChange={(e) => setSearchInput(e.target.value)}
                        type='text'
                        className='px-4 w-auto bg-transparent outline-none rounded-full text-black dark:text-white'
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    />
                    {showLogoutDropdown && (
                        <div className="absolute right-0 top-14 bg-white dark:bg-gray-800 shadow-md rounded-lg p-2">
                            <div className="flex flex-col items-center">
                                <p className="text-lg font-semibold text-black dark:text-white">{authUser?.username}</p>
                                <button
            ...
            {searchUser?.length > 0 ? (
                <>
                    ...
                    <div className='mt-auto px-1 py-1 flex'>
                        <button onClick={handleSearchBack} className='bg-white dark:bg-gray-800 rounded-full px-2 py-1 self-center'>
                ...
                <>
                    <div className="min-h-[70%] max-h-[80%] overflow-y-auto scrollbar">
                        <div className='w-auto'>
                            {chatUser.length === 0 ? (
                                <div className='font-bold items-center flex flex-col text-xl text-black dark:text-white'>
